...
namespace Starbender.RecipeApp.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20260212183452_BlobStorage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Starbender.BlobStorage.Entities.BlobMetadata", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("StoreType", "ContainerId", "BlobId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Starbender.RecipeApp.Domain.Shared.Entities.Instruction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Starbender.RecipeApp.Domain.Shared.Entities.Unit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Starbender.RecipeApp.Domain.Shared.Entities.RecipeIngredient", b =>
                {
                    ...
                    b.HasOne("Starbender.RecipeApp.Domain.Shared.Entities.Unit", "Unit")
                        .WithMany()
